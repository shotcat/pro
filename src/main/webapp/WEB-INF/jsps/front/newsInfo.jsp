...
<div class="container">
	...
	<div class="post">
		<div class="post-content" >
			<div class="post-title" style="text-align: center;"><h2><a href="blog_post.html">${news.title }</a></h2></div>
			<div class="post-meta" style="text-align: center;"><span><i class="mini-ico-calendar"></i><fmt:formatDate value="${news.updateTime }" pattern="yyyy-MM-dd hh:mm:ss"/></span> <span><i class="mini-ico-user"></i>发布人: <a href="#">管理员</a></span> <span><i class="mini-ico-comment"></i>共 <a href="#">12 评论</a></span></div>
