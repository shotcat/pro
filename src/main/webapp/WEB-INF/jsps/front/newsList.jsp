...
<div class="container">
	...
	<div class="sixteen columns">
		...
		<!-- Page Title -->
		<div id="page-title">
			<h2><a href="<c:url value='/news/list_2_1.shtml'/>">新闻中心</a></h2>
...
<div class="container">
	...
	<!-- Large Notice -->
		<div class="large-notice">
			...
			<a href="<c:url value='/news/info_${article.id}.shtml'/>" class="button  color">查看更多详情</a>
		</div>
		</c:forEach>
		<br>
		<ul class="pagination">
		<c:if test="${pager.hasPreviousPage }">
		<a href="<c:url value='/news/list_2_1.shtml'/>"><li>首页</li></a>
		<a href="<c:url value='/news/list_2_${pager.pageNumber -1}.shtml'/>"><li>上一页</li></a>
		</c:if>
		...
		<c:choose>
		  ...
		  <c:otherwise>
		  <a href="<c:url value='/news/list_2_${num}.shtml'/>"><li>${num }</li></a>
		  </c:otherwise>
		</c:choose>
		</c:forEach>
		<c:if test="${pager.hasNextPage }">
		<a href="<c:url value='/news/list_2_${pager.pageNumber +1}.shtml'/>"><li>下一页</li></a>
		<a href="<c:url value='/news/list_2_${pager.pages}.shtml'/>"><li>尾页</li></a>
		</c:if>
	</div>
	<!-- 16 Columns End -->
